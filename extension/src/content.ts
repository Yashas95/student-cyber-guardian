...
function showRiskBanner(result: ScanResult): void {
  ...
  const learnBtn = banner.querySelector("#scg-learn-btn") as HTMLButtonElement;
  const learnSection = banner.querySelector("#scg-learn") as HTMLDivElement;
